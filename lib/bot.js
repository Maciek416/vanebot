...
module.exports = function(config) {
  ...
  bot.route(/(([wm])\2*)([^a-zA-Z]*)([o0]+)(\3)(\1)/gi, function(res) {
    var wowmomMessage = wowmom(res.message);
    if(wowmomMessage != res.message){
      this.say(res.channel, wowmomMessage);
    }
  });
